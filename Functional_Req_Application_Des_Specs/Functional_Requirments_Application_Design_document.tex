...
\begin{itemize}
	...
	\item \textbf{HOD Recommendation service}
		\begin{itemize}
			...
			\item Recommend application: If the recommendation report has been completed.
	...
	\item \textbf{Dean endorsement service}
		\begin{itemize}
			...
			\item Endorse application: If the required endorsement information has been completed.									
		\end{itemize}
	...
	\item \textbf{DRIS approval service}
		\begin{itemize}
			...
			\item Decline: The fellow is older than 40 and has not obtained their PhD in the last 5 years or if the prospective fellow does not have a PhD.
			...
			\item Decline: The Dean's office member has selected an application that has a pending funding decision.
