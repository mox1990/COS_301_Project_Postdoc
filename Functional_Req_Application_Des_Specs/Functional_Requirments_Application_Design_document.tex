...
\begin{itemize}
	...
	\item Fig 3.
		\begin{itemize}
			\item Authenticate DRIS privileges: User needs to be logged in.
			\item Create report: If a user with the associated credentials has been authenticated.
	...
	\item Fig 7.
			\begin{itemize}
				...
				\item Query audit table: If has the correct security privileges.										
			\end{itemize}
	\item Fig 8.
			\begin{itemize}
	...
	\item Fig 12.
		\begin{itemize}
			\item Load pending applications: If there are any pending applications for the referee.
	...
	\item Fig 13.
		\begin{itemize}
			\item Load pending applications: If there are any pending applications for the grant holder.
	...
	\item Fig 14.
		\begin{itemize}
			\item Load pending applications: If there are any finalised application available for approval and the grant holder of the application falls under department the HOD is in charge of.
	...
	\item Fig 15.
		\begin{itemize}
			\item Load pending applications: If there are any approved application available for endorsement and the grant holder of the application falls under faculty of which the Dean's office is in charge of.
