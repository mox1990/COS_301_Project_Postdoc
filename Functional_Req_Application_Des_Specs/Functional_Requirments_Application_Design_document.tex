...
\subsubsection{Application services}
	...
	\begin{itemize}
		...
		\begin{enumerate}
			\item A DRIS member must be able to forward any application through the various stages in the application pipeline (Submitted to endorsed). 
			\item A DRIS member must be able to rewind any application through the various stages in the application pipeline (Open to endorsed).  
...
\begin{figure}[H]
\centering	
\framebox{\includegraphics[scale=0.9]{../Images_Docs/Diagrams/Use case diagrams/User account management services1.jpg}}
...
\begin{itemize}
	\item \textbf{User gateway}
		\begin{itemize}
			...
			\item Authenticate as owner: User is logged in and an object has been selected for ownership test.
	...
	\item \textbf{Referees' report service}
		\begin{itemize}
			\item Load pending applications: There are applications that need a referral report form the referee.
	...
	\item \textbf{Grant holder application finalisation service}
		\begin{itemize}
			\item Load pending applications: There are applications that need to be finalised by the grant holder.
			\item Create or Update Grant holder CV: The grant holder does not have a CV or has a CV.
			\item Finalise application: If grant holder has selected any application that is still pending.
