...
\subsubsection*{Use case diagram of Post-doctoral fellowship management system}
Priority: Critical

\subsubsection*{Use case diagram of Application service}
Priority: Critical

\subsubsection*{Use case diagram of Report service}
Priority: Important

\subsubsection*{Use case diagram of Notification services}
Priority: Critical

\subsubsection*{Use case diagram of User account management services}
Priority: Critical

\subsubsection*{Use case diagram of Application progress viewer service}
Priority: Critical

\subsubsection*{Use case diagram of New fellowship application service}
Priority: Critical

\subsubsection*{Use case diagram of Fellowship renewal service}
Priority: Critical

\subsubsection*{Use case diagram of Referees' report service}
Priority: Important

\subsubsection*{Use case diagram of HOD Approval service}
Priority: Critical

\subsubsection*{Use case diagram of Dean endorsement service}

\subsubsection*{Use case diagram of DRIS approval service}
Priority: Critical

\subsubsection*{Use case diagram of Meeting management service}
...
\begin{figure}[H]
\centering	
\framebox{\includegraphics[scale=0.45]{./Pictures/Diagrams/DomainObjects/DomainObjects.jpg}}
