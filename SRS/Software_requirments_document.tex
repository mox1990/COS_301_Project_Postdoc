...
\begin{itemize}
	...
	\item Fig 10.
		\begin{itemize}
			\item Application approval: If any application is available for approval and the grant holder of the application falls under department the HOD is in charge of.
	...
	\item Fig 11.
		\begin{itemize}
			\item Endorse application: If any application is available for endorsement and the grant holder of the application falls under faculty of which the Dean's office is in charge of.
	...
	\item Fig 12.
		\begin{itemize}
			\item Check eligibility: If any application is available for checking its eligibility.
...
\begin{itemize}
	...
	\item Fig 4.
			\begin{itemize}
				...
				\item Specify message: The notification has message.
