...
import com.softserve.ejb.nonapplicationservices.ResourceBundleServiceLocal;
            ...
            protected Object[][] getContents() {
                try {
                    ...
                    for (Iterator<ResourceEntity> it = resources.iterator(); it.hasNext();) {
                        ...
                        System.out.println("$: " + resource.getKey() + "=" + resource.getKey());
                    ...
                    System.out.println("We are not executing the query... for " + locale.getLanguage());
                    Logger.getLogger(DatabaseResourceBundle.class.getName()).log(Level.SEVERE, null, ex);
                    return null;
                }
            }
        }
