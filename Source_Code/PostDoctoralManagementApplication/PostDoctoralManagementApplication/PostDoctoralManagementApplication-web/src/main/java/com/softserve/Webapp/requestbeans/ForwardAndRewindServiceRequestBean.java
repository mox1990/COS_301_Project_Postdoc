...
public class ForwardAndRewindServiceRequestBean {
    ...
    public List<String> getPossibleStatusChanges(Application application)
    {
        ...
        {
            output.add(com.softserve.auxiliary.constants.PersistenceConstants.APPLICATION_STATUS_OPEN);
            output.add(com.softserve.auxiliary.constants.PersistenceConstants.APPLICATION_STATUS_SUBMITTED);
            output.add(com.softserve.auxiliary.constants.PersistenceConstants.APPLICATION_STATUS_REFERRED);
            output.add(com.softserve.auxiliary.constants.PersistenceConstants.APPLICATION_STATUS_FINALISED);
            output.add(com.softserve.auxiliary.constants.PersistenceConstants.APPLICATION_STATUS_RECOMMENDED);
            output.add(com.softserve.auxiliary.constants.PersistenceConstants.APPLICATION_STATUS_ENDORSED);
