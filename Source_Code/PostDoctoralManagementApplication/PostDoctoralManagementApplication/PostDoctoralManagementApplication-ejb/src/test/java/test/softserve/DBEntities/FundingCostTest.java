...
public class FundingCostTest {
    ...
    {
        FundingCost instance = new FundingCost(Long.MIN_VALUE);
        instance.setType(com.softserve.auxiliary.constants.PersistenceConstants.FUNDINGCOST_TYPE_CONFERENCE);
        assertEquals(com.softserve.auxiliary.constants.PersistenceConstants.FUNDINGCOST_TYPE_CONFERENCE,instance.getType());
    }
