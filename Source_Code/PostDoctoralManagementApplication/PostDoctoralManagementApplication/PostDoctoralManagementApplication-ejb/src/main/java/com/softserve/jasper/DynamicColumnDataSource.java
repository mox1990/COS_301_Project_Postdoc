...
/**
 * Implementation of a Jasper Reports data source that can contain a dynamic 
 * number of columns. 
 * 
 * As developed by Jeff Ortman on >> http://solutiondesign.com/building-dynamic-columns-in-jasperreports/ <<
 * 
