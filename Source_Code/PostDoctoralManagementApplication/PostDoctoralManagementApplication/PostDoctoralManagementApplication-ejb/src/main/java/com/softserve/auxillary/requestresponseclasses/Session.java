...
public class Session {
    ...
    public boolean isUserAccountDisabled()
    {
        ...
        else
        {
            ...
            return user.getAccountStatus().equals(com.softserve.auxillary.constants.PersistenceConstants.ACCOUNT_STATUS_DISABLED);
        }               
    ...
    public boolean isUserAccountDorment()
    {
        ...
        else
        {
            ...
            return user.getAccountStatus().equals(com.softserve.auxillary.constants.PersistenceConstants.ACCOUNT_STATUS_DORMENT);
        } 
    }
    ...
    public boolean isUserAccountActive()
    {
        ...
        else
        {
            ...
            return user.getAccountStatus().equals(com.softserve.auxillary.constants.PersistenceConstants.ACCOUNT_STATUS_ACTIVE);
        } 
    }
}
