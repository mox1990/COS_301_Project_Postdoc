...
public class AnnouncementManagementService implements AnnouncementManagementServiceLocal {
    ...
    @SecuredMethod(AllowedSecurityRoles = {com.softserve.auxiliary.constants.PersistenceConstants.SECURITY_ROLE_ID_DRIS_MEMBER, com.softserve.auxiliary.constants.PersistenceConstants.SECURITY_ROLE_ID_SYSTEM_ADMINISTRATOR} )
    @AuditableMethod 
    @Override
