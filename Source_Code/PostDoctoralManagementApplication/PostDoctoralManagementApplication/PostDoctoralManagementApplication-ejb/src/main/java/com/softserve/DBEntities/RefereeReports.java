...
public class RefereeReports implements Serializable {
    ...
    private NewApplications applicationID;
    ...
    public NewApplications getApplicationID() {
        return applicationID;
    }

    public void setApplicationID(NewApplications applicationID) {
    ...
    public String toString() {
        return "com.softserve.DBEntities.RefereeReports[ reportID=" + reportID + " ]";
    }
