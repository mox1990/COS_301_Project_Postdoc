...
%\textbf{Improvement} %Benefits to the systems
%
%This requirement will keep the system robust and ensure the quality of the auditablilty.
%\vspace{0.1in}
...
% This trade off is questionable...
