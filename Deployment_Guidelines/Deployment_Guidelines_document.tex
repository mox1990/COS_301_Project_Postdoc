...
\newcommand{\javaInstall}{http://docs.oracle.com/javase/8/docs/technotes/guides/install/install_overview.html}
...
Glassfish provides a number of ways to deploy an application. The autodeploy method requires that the .war file be situated in the autodeploy (\textbf{\seqsplit{~/glassfish-4.0/glassfish/domains/domain1/autodeploy/}}) folder.\\ 
\\
