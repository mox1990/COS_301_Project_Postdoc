...
The Factory Design Pattern provides centralised to create our Database entities and entries in an orderly fashion. This allows for separation of concerns, amongst the classes. Using the Factory relates back to Re-Usability. % It's main focus is to enable polymorphism. I, Alfred, didn'tsee where we have used this in the system so far.
